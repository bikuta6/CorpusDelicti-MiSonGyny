...
TEST_LYRICS_PATH = "../../data/task2/processed_test.csv"
TEST_LABELS_PATH = "../../data/task2/test_labels.csv"
MODELS_DIR = "../../models/task2/comparison"
RESULTS_FILE = "../../results/task2/tabla_paper_test.csv"
BEST_THRESHOLDS_PATH = "../../results/task2/tabla_paper.csv"
BATCH_SIZE = 32
ID2LABEL = {0: "NM", 1: "M"}
