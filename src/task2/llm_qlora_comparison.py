...
# --- CONFIGURACIÓN ---
DATA_PATH = "../../data/task2/processed_train.csv"
OUTPUT_DIR = "../../models/task2/comparativa_llm"
RESULTS_FILE = "../../results/task2/tabla_paper_llms.csv"
SAVE_DIR = "../../models/task2/comparison_llm"
