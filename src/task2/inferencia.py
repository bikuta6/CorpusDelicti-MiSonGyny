...
VAL_FILE = "../../data/task2/validation.csv"
MODELS_DIR = "../../models/task2/ensemble"
OUTPUT_FILE = "../../results/task2/submission.csv"
STACKER_PATH = "../../models/task2/ensemble/stacker.pkl"  # Meta-modelo
