...
MODELS_BASE_DIR = "../../models/task2/comparison"
TEST_PATH = "../../data/task2/processed_test.csv"
RESULTS_FILE = "../../results/task2/submission_ensemble.csv"
BATCH_SIZE = 32
...
def main():
    ...
    true_labels_df = pd.read_csv("../../data/task2/test_labels.csv")
