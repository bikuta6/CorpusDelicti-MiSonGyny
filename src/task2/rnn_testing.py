...
Uso:
    ...
    --data_path        Ruta al CSV de entrenamiento (default: ../../data/task2/processed_train.csv)
    --test_path        Ruta al CSV de test         (default: ../../data/task2/test.csv)
    --test_labels_path Ruta a las etiquetas de test (default: ../../data/task2/test_labels.csv)
    --results_file     Fichero CSV de resultados    (default: ../../results/task2/tabla_rnn.csv)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data_path", type=str,
                        default="../../data/task2/processed_train.csv")
    parser.add_argument("--test_path", type=str,
                        default="../../data/task2/processed_test.csv")
    parser.add_argument("--test_labels_path", type=str,
                        default="../../data/task2/test_labels.csv")
    parser.add_argument("--results_file", type=str,
                        default="../../results/task2/tabla_rnn.csv")
