...
# --- CONFIGURACIÓN ---
DATA_PATH = "../../data/task3/processed_train.csv"
OUTPUT_DIR = "../../models/task3/comparativa_llm"
RESULTS_FILE = "../../results/task3/tabla_paper_llms.csv"
SAVE_DIR = "../../models/task3/comparison_llm"
