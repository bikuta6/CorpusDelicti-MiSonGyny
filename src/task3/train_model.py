"""
Entrenamiento y evaluación para un único modelo en Task 3.
"""
...
if __name__ == "__main__":
    arg_parser = argparse.ArgumentParser(description="Entrenamiento de un modelo basado en BERT para Task 3")
