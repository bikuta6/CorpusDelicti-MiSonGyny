...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Script de predicción para Task 3")
    parser.add_argument(
        "--model_path",
        type=str,
        required=True,
        help="Ruta al directorio del modelo entrenado (ej. ../../models/task3/single/BETO)",
    )
    parser.add_argument(
        "--test_file",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="Umbral de decisión para la clase positiva (Y)",
    )
    parser.add_argument(
