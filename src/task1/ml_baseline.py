...
if __name__ == "__main__":
    ...
    train_df = pd.read_csv(os.path.join(base, "data", "task1", "train_df.csv"))
    val_df = pd.read_csv(os.path.join(base, "data", "task1", "val_df.csv"))
    test_df = pd.read_csv(os.path.join(base, "data", "task1", "dev_df.csv"))
    ...
    # 6. Save Results
    results_file = os.path.join(base, "results", "task1", "ml_baseline_results.csv")
